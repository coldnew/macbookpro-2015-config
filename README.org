...
The kernel I use is [[https://github.com/coldnew/coldnew-kernel][coldnew-kernel]], which tracked with linux-git and apply zfs
patches and some patch may make macbook work more nicely. You can find my config
in =examples/kernel-config= folder.

Currently I'm test on kernel =p4.1= branch, which is based on Linux Kernel 4.1.0-rc3.
...
- [X] trackpad
  ...
  You need to apply patches in bugzilla to make this work!!

  test on linux kernel 4.1-rc5
